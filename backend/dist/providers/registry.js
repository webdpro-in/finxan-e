...
export class ProviderRegistry {
    static aiProvider = null;
    static ttsProvider = null;
    static sttProvider = null;
    static imageProvider = null;
    /**
     ...
     * @throws Error if provider name is unknown
     */
    static async createAIProvider(providerName) {
        switch (providerName) {
            case 'gemini':
     ...
     * @throws Error if provider name is unknown
     */
    static async createTTSProvider(providerName) {
        switch (providerName) {
            case 'aws-polly':
     ...
     * @throws Error if provider name is unknown
     */
    static async createSTTProvider(providerName) {
        switch (providerName) {
            case 'aws-transcribe':
     ...
     * @throws Error if provider name is unknown
     */
    static async createImageProvider(providerName) {
        switch (providerName) {
            case 'aws-bedrock':
